...
if ([string]::IsNullOrWhiteSpace($RunLabel)) {
    $RunLabel = "stas2_$($Day.Replace('-', ''))_$($EndDay.Replace('-', ''))_market_phase_review"
}
...
Write-Host ""
Write-Host "STAS2 market phase review range finished. Open latest result:"
