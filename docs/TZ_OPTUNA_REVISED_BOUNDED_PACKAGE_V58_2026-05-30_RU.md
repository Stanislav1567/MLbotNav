# TZ_OPTUNA_REVISED_BOUNDED_PACKAGE_V58_2026-05-30_RU

Date: 2026-05-30
Scope: Optuna/APTuna only (ML runtime untouched)

## 1. Basis
1. V57 sequence completed with NO_GO at V57-S4.
2. Observed pattern after V57:
...
## 3. Bounded Package V58 (strict)
1. V58-S1: long tradefulness unlock continuation.
`PLongGrid=0.14,0.13,0.12`; `MinExpectedMoveGrid=0.0020,0.0022,0.0024`; `MinCandidateTrades=3`.
2. V58-S2: short entry re-anchor continuation.
`PShortGrid=0.11,0.10,0.09`; `StopLossPct=0.0020` preserved.
3. V58-S3: short risk/move micro-correction.
`StopLossPct=0.000025`; V58-S2 entry profile preserved.
4. V58-S4: cross-mode confirmation + micro-gate.
...
## 6. DoD for V58 package task
1. V58 package doc created and linked from priorities.
