...
def main() -> int:
    parser = argparse.ArgumentParser(description="AKFP P4: HYP_ONLY cycle (long/short separately).")
    parser.add_argument("--policy", default="configs/akfp_policy.yaml")
    parser.add_argument("--output-dir", default="reports/akfp/hyp_only")
    ...
    out = out_dir / f"akfp_hyp_only_cycle_{symbol}_{timeframe}_{test_date}_{_utc_tag()}.json"
